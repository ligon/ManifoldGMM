...
from manifoldgmm.econometrics.gmm import GMMResult, MomentRestriction, WaldTestResult
...
def test_wald_test_nonzero_statistic():
    ...
    restriction = MomentRestriction(
        gi_jax=gi_jax, data=jnp.array([1.0]), manifold=manifold, backend="jax"  # Dummy
    )
