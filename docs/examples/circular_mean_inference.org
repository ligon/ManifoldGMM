...
* FAQ
- Why does =result.theta= show a =DataVec= while JAX still works? :: The raw optimizer output lives in =result.theta_array=; =theta= is a formatted view created via =MomentRestriction.format_parameter= so you get labels without disturbing autodiff.
