...
| Circle Mean Inference         | [[file:examples/circular_mean_inference.org][examples/circular_mean_inference.org]]     | Mean direction on \(\mathbb{S}^1\) with manifold inference |
...
| Release Notes (0.3.0a1)        | [[file:release/notes_0.3.0a1.org][release/notes_0.3.0a1.org]]                     | Highlights for the v0.3.0a1 alpha release                |
| Release Notes (0.2.0a1)        | [[file:release/notes_0.2.0a1.org][release/notes_0.2.0a1.org]]                     | Highlights for the v0.2.0a1 alpha release                |
